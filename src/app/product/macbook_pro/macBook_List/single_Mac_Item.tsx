  ...
  return (
    <div className="font-sans text-left bg-customDarkGrey border-0 rounded-2xl w-[310px] p-4">
      ...
      <div className="flex flex-col justify-start mt-10">
        {colorChoice == 0 ? (
          <p className="text-xs">{macItem.color.choice[0]}</p>
        ) : (
          <p className="text-xs">{macItem.color.choice[1]}</p>
        )}
        ...
        <div className="text-sm  leading-6 mt-4">
          ...
          <p>{macItem.adapter.choice[macItem.adapter.result].type}</p>
        </div>
        <div className="pt-5">
